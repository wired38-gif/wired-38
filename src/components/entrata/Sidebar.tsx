...
import {
  ...
  Users, ChevronRight, Star, BookOpen, Youtube, Rss,
  Building2, Layers
} from "lucide-react";
...
interface SidebarProps {
  ...
  onViewChange: (view: "workflow" | "reference" | "glossary" | "videos" | "research") => void;
  currentView: string;
        ...
        <div className="grid grid-cols-2 gap-1">
          ...
          >
            ...
            <span className={`text-[8px] px-1 py-0.5 rounded font-bold ${
              currentView === "research" ? "bg-cyan-500/30 text-cyan-300" : "bg-slate-700 text-slate-500"
            }`}>NEW</span>
          </button>
        </div>
      </div>
